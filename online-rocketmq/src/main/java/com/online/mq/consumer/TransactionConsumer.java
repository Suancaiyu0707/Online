...
public class TransactionConsumer {
    ...
    private final static String groupName = "tans_group_consumer";
    ...
    public static void main(String[] args) throws Exception {
        consumer.setMessageListener(new MessageListenerConcurrently() {
            ...
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> list,
                ...
                System.out.println("recevie message:"+list.get(0).getBody());
//                String id =  list.get(0).getMsgId();
//                if(status=="1"){
//                    insert(list.get(0).getMsgId(),msg.Mouney)
//                }else{
//                    update(list.get(0).getMsgId(),msg.Mouney)
//                }

...
public class SentryConfig {
    //配置哨兵节点，不是redis集群节点
    private static final String sentinelAddress_1 = "redis://127.0.0.1:26379";
    private static final String sentinelAddress_2 = "redis://127.0.0.1:26380";
    private static final String sentinelAddress_3 = "redis://127.0.0.1:26381";
    private static final String masterName = "sentinel-online-redis";
    ...
    static {
        ...
        config.useSentinelServers()//这里指定采用的是哨兵的模式部署
                .setMasterName(masterName)//这个是在sentinel.conf配置的别名：sentinel monitor sentinel-online-redis 127.0.0.1 6379 2
                .addSentinelAddress(sentinelAddress_1)
                .addSentinelAddress(sentinelAddress_2)
                .addSentinelAddress(sentinelAddress_3);
